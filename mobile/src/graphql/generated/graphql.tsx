...
export type Mutation = {
  __typename?: 'Mutation';
  classifyWildAnimal: WildAnimalPredictionResponse;
};


export type MutationClassifyWildAnimalArgs = {
...
export type WildAnimalInput = {
  image: Scalars['Upload'];
};

export type WildAnimalPredictionResponse = {
  __typename?: 'WildAnimalPredictionResponse';
  error?: Maybe<Error>;
  ok: Scalars['Boolean'];
